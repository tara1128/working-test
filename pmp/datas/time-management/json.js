...
datas: {
    ...
    "pmp-062": {
      ...
      inputs: [
        {text: '1. 进度管理计划', ext: [{text: '6.1 规划进度管理的输出'}]},
        {text: '2. 范围基准', ext: [
    ...
    "pmp-063": {
      ...
      inputs: [
        {text: '1. 进度管理计划', ext: [{text: '过程6.1（规划进度管理）的输出'}]},
        {text: '2. 活动清单', ext: [{text: '过程6.2（定义活动）的输出'}]},
        {text: '3. 活动属性', ext: [{text: '过程6.2（定义活动）的输出'}]},
        {text: '4. 里程碑清单', ext: [{text: '过程6.2（定义活动）的输出'}]},
        {text: '5. 项目范围说明书', ext: [{text: '5.3 定义范围的输出'}]},
        {text: '6. 事业环境因素和组织过程资产'}
      ],
      tools: [
        {text: '1. 紧前关系绘图法（PDM）', cusWidth: 550, ext: [
        ...
        {text: '2. 确定依赖关系', cusWidth: 500, ext: [
        ...
        {text: '4. 提前量与滞后量', cusWidth: 480, ext: [
      ...
      outputs: [
        {text: '1. 项目进度网络图', cusWidth: 420, ext: [
    ...
    "pmp-064": {
      ...
      inputs: [
        {text: '1. 进度管理计划', ext: [{text: '6.1 规划进度管理的输出'}]},
        {text: '2. 活动清单', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '3. 活动属性', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '4. 资源日历', cusWidth: 480, ext: [
          {text: '9.2 组建项目团队的输出'},
        ...
        {text: '5. 风险登记册'},
        {text: '6. 活动成本估算', ext: [{text: '7.2 估算成本的输出'}]},
        {text: '7. 事业环境因素和组织过程资产'}
      ],
      tools: [
        {text: '1. 专家判断'},
        {text: '2. 备选方案分析'},
        {text: '3. 发布的估算数据'},
        {text: '4. 自下而上的估算', cusWidth: 420, ext: [
      ...
      outputs: [
        ...
        {text: '2. 资源分解结构RBS', cusWidth: 480, ext: [
    ...
    "pmp-065": {
      ...
      inputs: [
        ...
        {text: '2. 活动清单', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '3. 活动属性', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '4. 活动资源需求', ext: [{text: '6.4 估算活动资源的输出'}]},
        {text: '5. 资源日历', ext: [
          {text: '9.2 组建项目团队的输出'},
          {text: '6.4 估算活动资源的输入也有资源日历'}
        ]},
        {text: '6. 项目范围说明书', ext: [{text: '5.3 定义范围的输出'}]},
        {text: '7. 风险登记册'},
        {text: '8. 资源分解结构RBS', ext: [{text: '6.4 估算活动资源的输出'}]},
        {text: '9. 事业环境因素和组织过程资产'}
      ],
      tools: [
        {text: '1. 专家判断'},
        {text: '2. 类比估算', cusWidth: 500, ext: [
      ...
      outputs: [
        {text: '1. 活动持续时间估算', cusWidth: 420, ext: [
    ...
    "pmp-066": {
      ...
      inputs: [
        ...
        {text: '2. 活动清单', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '3. 活动属性', ext: [{text: '6.2 定义活动的输出'}]},
        {text: '4. 项目进度网路图', ext: [{text: '6.3 排列活动顺序的输出'}]},
        {text: '5. 活动资源需求', ext: [{text: '6.4 估算活动资源的输出'}]},
        {text: '6. 资源日历', ext: [
          {text: '9.2 组建项目团队的输出'},
          {text: '6.4 估算活动资源的输入也有资源日历'}
        ]},
        {text: '7. 活动持续时间估算', ext: [{text: '6.5 估算活动持续时间的输出'}]},
        {text: '8. 项目范围说明书', ext: [{text: '5.3 定义范围的输出'}]},
        {text: '9. 风险登记册'},
        {text: '10. 项目人员分派'},
        {text: '11. 资源分解结构RBS', ext: [{text: '6.4 估算活动资源的输出'}]},
        {text: '12. 事业环境因素和组织过程资产'}
      ],
      tools: [
        {text: '1. 进度网络分析', cusWidth: 420, ext: [
          {text: '计算项目中未完成部分的最早和最晚开始时间、最早和最晚完成时间，是创建项目进度模型的一种技术'},
          {text: '分析活动之间的逻辑关系，主要有四种方法：关键路径法、关键链法、资源优化技术、建模技术'},
        ]},
        {text: '2. 关键路径法CPM', cusWidth: 550, ext: [
        ...
        {text: '4. 资源优化技术', cusWidth: 520, ext: [
      ...
      outputs: [
        ...
        {text: '2. 项目进度计划', cusWidth: 420, ext: [
          {text: '进度计划有三个类型：'},
    ...
    "pmp-067": {
      ...
      inputs: [
        {text: '1. 项目管理计划', ext: [{text: '4.2 制定项目管理计划的输出'}]},
        {text: '2. 项目进度计划', ext: [{text: '6.6 制定进度计划的输出'}]},
        {text: '3. 工作绩效数据'},
        {text: '4. 项目日历', ext: [{text: '6.6 制定进度计划的输出'}]},
        {text: '5. 进度数据', ext: [{text: '6.6 制定进度计划的输出'}]},
        {text: '6. 事业环境因素和组织过程资产'}
      ],
      tools: [
        {text: '1. 绩效审查', cusWidth: 420, ext: [
          {text: '测量、对比、分析进度绩效，如开始日期、完成日期、已完成百分比、当前工作剩余持续时间'},
          {text: '需要分析偏离进度基准的原因和程度，评估这些偏差对未来工作的影响，确定是否采取纠正或预防措施！'},
          {text: '包括：趋势分析、关键路径法、关键链法、挣值管理'},
          {text: '注：非关键路径的某个活动延误，对进度没有影响'},
          {text: '注：关键或次关键活动延误，需立即采取行动（如进度压缩）'}
        ]},
        {text: '2. 项目管理软件'},
        {text: '3. 资源优化技术'},
        {text: '4. 建模技术'},
      ...
      outputs: [
        ...
        {text: '2. 进度预测'},
        {text: '3. 变更请求'},
        {text: '4. 项目管理计划（更新）', cusWidth: 420, ext: [
          {text: '进度基准更新：因项目范围、活动资源、活动持续时间等的变更获得批准，或采用了进度压缩技术，使进度基准更新'},
          {text: '进度管理计划同时更新'},
          {text: '成本基准更新：因进度压缩技术导致成本变更（赶工需要增加成本）'},
        ]},
        {text: '5. 项目文件更新'},
        {text: '6. 组织过程资产更新'}
      ]
