          ...
          tool: {
            ...
            data: [
            ...
            
              {
                ...
                slog: '',
                icon: '/dist/images/brandnew-logo-kb-103.png',
                descForIndex: ['First third-party input app to use deep learning technology. The #1 personalization app on Google Play in 50 countries'],
            ...
            data: [          
              {
                ...
                slog: '',
                icon: '/dist/images/brandnew-logo-pt2-103.png',
                descForIndex: ['Music-based casual game with nearly 900 million downloads worldwide. Most downloaded music-based casual game on App Store and Google Play in 2016.'],
            ...
            
              {
                ...
                slog: '',
                icon: '/dist/images/brandnew-game-bg-dl-icon.png',
                descForIndex: ['All original rhythm-based casual game with a 4.8 user rating on Google Play. One of Google’s Best Games of 2017.'],
            ...
            data: [          
              {
                ...
                slog: '',
                icon: '/dist/images/brandnew-logo-nr-103.png',
                descForIndex: ['Personalized news aggregation app with content from nearly 3,000 media sources, covering 43 countries and 47 languages. Previously #1 news app on Google Play in 60 countries.'],
